...
def fcn(node, is_training=False, keep_prob=0.9):
    ...
    if tf.executing_eagerly():
        node = conv_part(
            1, node, height_k_size=8, width_k_size=6, in_size=3, out_size=64, p_stride=3,
    ...
    node = conv_part(
        2, node, height_k_size=6, width_k_size=4, in_size=64, out_size=96, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob
    )

    node = conv_part(
        3, node, height_k_size=3, width_k_size=2, in_size=96, out_size=128, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob
    )
    ...
    return node, total_l2_norm


def afcn(node, is_training=False, keep_prob=0.9):
    ...
    if tf.executing_eagerly():
        node = conv_part(
            1, node, height_k_size=8, width_k_size=6, in_size=3, out_size=48, p_stride=3,
            show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=None
        )
    else:
        node = conv_part(
    ...
    node = conv_part(
        2, node, height_k_size=6, width_k_size=4, in_size=48, out_size=72, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob
    )

    node = conv_part(
        3, node, height_k_size=3, width_k_size=2, in_size=72, out_size=96, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob
    )

    node = conv_fc_part(
        1, node, height_k_size=6, width_k_size=3, in_size=96, out_size=1024,
        activation='relu', keep_prob=keep_prob
    )
...
def bfcn(node, is_training=False, keep_prob=0.9):
    node = head(node, is_training)
    ...
    if tf.executing_eagerly():
        node = conv_part(
            1, node, height_k_size=8, width_k_size=6, in_size=3, out_size=36, p_stride=1,
            show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=None, padding='VALID'
        )
    else:
        node = conv_part(
            1, node, height_k_size=8, width_k_size=6, in_size=3, out_size=36, p_stride=1,
            show_visualization=True, l2_norm_collector=l2_norm_list, keep_prob=None, padding='VALID'
        )

    node = conv_part(
        2, node, height_k_size=6, width_k_size=4, in_size=36, out_size=54, p_stride=1,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob, padding='VALID'
    )

    node = conv_part(
        3, node, height_k_size=3, width_k_size=2, in_size=54, out_size=54, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob, padding='VALID'
    )

    node = conv_part(
        4, node, height_k_size=3, width_k_size=2, in_size=54, out_size=54, p_stride=2,
        show_visualization=False, l2_norm_collector=l2_norm_list, keep_prob=keep_prob, padding='VALID'
    )

    node = conv_fc_part(
        1, node, height_k_size=9, width_k_size=3, in_size=54, out_size=1024,
        activation='relu', keep_prob=keep_prob
    )
